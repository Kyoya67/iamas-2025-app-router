    ...
    return (
        <div className="absolute inset-0 flex justify-center">
            <div className="
                ...
                mt-[10rem] sm:mt-[14rem]
                w-[18rem] sm:w-[23rem]
                "
                style={{ lineHeight: '1.8', fontSize: 'clamp(0.78rem, 3.2vw, 1.3rem)' }}>
                ...
                その集大成を発表する場として、このたび「IAMAS 2025」と題した成果展を開催いたします。<br></br>
                今年度のテーマは「苦悩と誠実」です。23期生は、個々の研究活動において、一筋縄ではいかない困難に直面し、何度も悩み、苦しむ場面がありました。
                それでも、自身と研究に深く向き合い、誠実に取り組む姿勢を貫き、作品・研究を強固なものへと形作りました。
                このプロセスは、ときに滑らかで、ときに粗い軌跡を残しながら、円環を描くように内省と挑戦を重ねていくものとして捉えられます。<br></br>
                苦悩の中で誠実に研究と向き合い続けた23期生の成果を、ぜひご高覧ください。<br></br>
                <br></br>
