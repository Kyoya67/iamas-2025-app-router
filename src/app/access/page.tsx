...
export default function Access() {
    return (
        <div className="
            ...
            min-[500px]:w-[80%] min-[500px]:max-w-[32rem] 
            md:max-w-[70vw]
            mx-auto 
            ten-mincho-text
        ">
            <h1 className="
                mt-[18vh] min-[390px]:mt-[15vh] md:mt-[10vh] 
                md:ml-[5rem]
                pr-4
                text-[#000f9f] text-xl min-[500px]:text-2xl ten-mincho border-b border-black">
                ACCESS
            </h1>
            ...
            ">
                <div>
                    <div className="flex flex-col">
                        <div className="xl:flex xl:gap-4 xl:items-start">
                            ...
                            <div className="mt-2 xl:mt-4 xl:w-[45%]">
                                <div className="flex items-center gap-2">
                                    <div className="text-[#000f9f] text-base min-[500px]:text-xl ten-mincho">
                                        大垣駅より
                                    </div>
                                    <div className="h-[1px] bg-[#000f9f] flex-grow"></div>
                                </div>
                                <div className="text-[0.63rem] min-[500px]:text-sm ten-mincho-text text-black">
                                    <div>
                                        タクシー：JR大垣駅南口から約5分
                                    </div>
                                    <div>
                        ...
                        <div className="xl:flex xl:gap-4 xl:items-start mt-0 min-[500px]:mt-4">
                            ...
                            <div className="mt-3 xl:mt-7 xl:w-[45%]">
                                <div className="flex items-center gap-2">
                                    <h2 className="text-[#000f9f] text-base min-[500px]:text-xl ten-mincho">
                                        東京方面より
                                    </h2>
                                    <div className="h-[1px] bg-[#000f9f] flex-grow"></div>
                                </div>
                                ...
                                <div className="flex items-center gap-2">
                                    <h2 className="text-[#000f9f] text-base min-[500px]:text-xl ten-mincho mt-3">
                                        大阪方面より
                                    </h2>
                                    <div className="h-[1px] bg-[#000f9f] flex-grow"></div>
                                </div>
                                ...
                                <div className="text-[0.6rem] min-[500px]:text-[0.85rem] ten-mincho-text text-black">
                                    <div>
                        ...
                        <div className="xl:flex xl:gap-4 xl:items-start mt-8 min-[500px]:mt-12 mb-[3rem]">
                            <div className="xl:w-[55%]">
                                <Image
                            ...
                            <div className="mt-2 xl:-mt-2 text-[0.9rem] md:text-lg xl:w-[45%] xl:text-[0.95rem]">
                                ...
                                <div className="mt-2 text-black text-xs min-[500px]:text-base md:text-lg">
                                    <div>
                                        時間：8:30~21:30
                                    </div>
                                    <div>
